...
def get_data(input_path, train):
    ...
    Args:
        input_path: annotation file path, possible variants are for train and test
        train: boolean
        ...
        for line in f:
            ...
            for box in boxes:
                all_imgs[filename]['bboxes'].append(
                    {'class': class_name, 'x1': int(box[0]), 'y1': int(box[1]), 'x2': int(box[2]), 'y2': int(box[3])})
